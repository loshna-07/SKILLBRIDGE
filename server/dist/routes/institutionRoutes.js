...
router.get('/intelligence', (0, authMiddleware_1.authorizeRoles)('INSTITUTION'), institutionController_1.getInstitutionIntelligenceAnalytics);
router.get('/analytics', (0, authMiddleware_1.authorizeRoles)('INSTITUTION'), institutionController_1.getInstitutionIntelligenceAnalytics);
router.get('/branch-analytics', (0, authMiddleware_1.authorizeRoles)('INSTITUTION'), institutionController_1.getInstitutionBranchAnalyticsController);
router.get('/students', (0, authMiddleware_1.authorizeRoles)('INSTITUTION'), institutionController_1.getInstitutionStudents);
router.get('/students/:id', (0, authMiddleware_1.authorizeRoles)('INSTITUTION'), institutionController_1.getInstitutionStudentById);
router.get('/applications', (0, authMiddleware_1.authorizeRoles)('INSTITUTION'), institutionController_1.getInstitutionStudentApplications);

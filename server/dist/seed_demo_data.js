...
async function seedDemoData() {
    ...
    for (const catData of skillCategories) {
        const category = await db_1.default.skillCategory.upsert({
        ...
        for (const s of catData.skills) {
            const skill = await db_1.default.skill.upsert({
                where: { name: s.name },
    ...
    const webAssessment = await db_1.default.assessment.create({
        data: {
    ...
    const dsAssessment = await db_1.default.assessment.create({
        data: {
    ...
    const citUser = await db_1.default.user.create({
        data: {
    ...
    const siieUser = await db_1.default.user.create({
        data: {
    ...
    const academician1 = await db_1.default.user.create({
        data: {
    ...
    const academician2 = await db_1.default.user.create({
        data: {
    ...
    const technovaUser = await db_1.default.user.create({
        data: {
    ...
    const cloudsphereUser = await db_1.default.user.create({
        data: {
    ...
    const datamindUser = await db_1.default.user.create({
        data: {
    ...
    const student1User = await db_1.default.user.create({
        data: {
    ...
    const student2User = await db_1.default.user.create({
        data: {
    ...
    const student3User = await db_1.default.user.create({
        data: {
    ...
    const student4User = await db_1.default.user.create({
        data: {
    ...
    const student5User = await db_1.default.user.create({
        data: {

...
const clear_demo_data_1 = __importDefault(require("./clear_demo_data"));
async function seedMultiDomainDemo() {
    ...
    await (0, clear_demo_data_1.default)();
    ...
    const catAyuFund = await db_1.default.skillCategory.upsert({
    ...
    const catEngTech = await db_1.default.skillCategory.upsert({
    ...
    const catComBiz = await db_1.default.skillCategory.upsert({
    ...
    for (const s of skillsData) {
        const created = await db_1.default.skill.upsert({
            where: { name: s.name },
    ...
    const instDhanvantari = await db_1.default.user.create({
        data: {
    ...
    const instSIIA = await db_1.default.user.create({
        data: {
    ...
    const instKARI = await db_1.default.user.create({
        data: {
    ...
    const instSSN = await db_1.default.user.create({
        data: {
    ...
    const instSICI = await db_1.default.user.create({
        data: {
    ...
    const acadSuresh = await db_1.default.user.create({
        data: {
    ...
    const acadPriyaRaman = await db_1.default.user.create({
        data: {
    ...
    const acadKarthik = await db_1.default.user.create({
        data: {
    ...
    const indPrana = await db_1.default.user.create({
        data: {
    ...
    const indTechNova = await db_1.default.user.create({
        data: {
    ...
    const indEmbeddedLabs = await db_1.default.user.create({
        data: {
    ...
    const indFinEdge = await db_1.default.user.create({
        data: {
    ...
    const stuAnanya = await db_1.default.user.create({
        data: {
    ...
    const stuArjun = await db_1.default.user.create({
        data: {
    ...
    const stuMeera = await db_1.default.user.create({
        data: {
    ...
    const stuRohan = await db_1.default.user.create({
        data: {
    ...
    const stuKavya = await db_1.default.user.create({
        data: {
    ...
    const stuVishal = await db_1.default.user.create({
        data: {
    ...
    const stuPriya = await db_1.default.user.create({
        data: {
    ...
    const stuRahul = await db_1.default.user.create({
        data: {
    ...
    const stuSneha = await db_1.default.user.create({
        data: {
    ...
    const stuAditya = await db_1.default.user.create({
        data: {
    ...
    const addStudentSkill = async (studentId, skillName, level, score) => {
    ...
    for (const m of courseDravya.modules) {
        for (const l of m.lessons) {
            await db_1.default.courseLessonProgress.create({
                data: {
    ...
    const priyaEnrollment = await db_1.default.courseEnrollment.create({
        data: {
    ...
    const snehaEnrollment = await db_1.default.courseEnrollment.create({
        data: {
    ...
    const createOpp = async (params) => {
        const opp = await db_1.default.opportunity.create({
            data: {
...
exports.default = seedMultiDomainDemo;

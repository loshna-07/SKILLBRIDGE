...
async function verifyDemoData() {
  ...
  try {
    ...
    const priyaFullStackMatch = priyaOpps.find((o: any) =>
      o.title.includes('Full Stack Web Developer Intern')
    );
    ...
    const rahulCloudMatch = rahulOpps.find((o: any) =>
      o.title.includes('Cloud & DevOps Engineering Intern')
    );
    ...
    const completedCourse = meeraEnrolled.find((e: any) => e.progressPercentage === 100);

...
async function seedAyurvedaDemo() {
  ...
  const clinicalAssessment = await prisma.assessment.create({
    data: {
  ...
  const dhanvantariInst = await prisma.user.create({
    data: {
  ...
  const siiaInst = await prisma.user.create({
    data: {
  ...
  const kariInst = await prisma.user.create({
    data: {
  ...
  const acadAnanya = await prisma.user.create({
    data: {
  ...
  const acadRavi = await prisma.user.create({
    data: {
  ...
  const acadMeenakshi = await prisma.user.create({
    data: {
  ...
  const indDhanvantari = await prisma.user.create({
    data: {
  ...
  const indKeralaHerbal = await prisma.user.create({
    data: {
  ...
  const indAyurvedaLife = await prisma.user.create({
    data: {
  ...
  const indPranaWellness = await prisma.user.create({
    data: {
  ...
  const studentMeera = await prisma.user.create({
    data: {
  ...
  const studentKavya = await prisma.user.create({
    data: {
  ...
  const studentVishal = await prisma.user.create({
    data: {
  ...
  const ananyaEnrollment = await prisma.courseEnrollment.create({
    data: {
